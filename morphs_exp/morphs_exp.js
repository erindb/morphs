...
experiment = {
  ...
  next: function (trialnum) {
      ...
      var displayPracticeQuestion = function() {
	    ...
	    newtext += ("<p>Some of the " + trialparameters.noun + "s are more <b>" +
	                trialparameters.adjective + "</b> than others.</p> <p>Please" +
	                " take a moment to study these " + trialparameters.noun + 
